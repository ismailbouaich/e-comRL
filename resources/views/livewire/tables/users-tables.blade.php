                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr wire:key="{{ $user->id }}" class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 {{ $user->role->name == 'admin' ? 'text-green-500' : ($user->role->name  == 'delivery_worker' ? 'text-blue-500' : 'text-red-500') }}">
                                            {{ $user->role->name}}
                                        </td>
                                        <td class="px-4 py-3">{{ $user->created_at }}</td>
                                        <td class="px-4 py-3">{{ $user->updated_at }}</td>
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <a onclick="confirm('Are you sure you want to delete {{ $user->name }} ?') || event.stopImmediatePropagation()"
                                                wire:click="delete({{ $user->id }})" class="text-red-500">
                                                ...
                                                <a href="{{ route('users.show', $user->id) }}" class="text-yellow-500 hover:text-yellow-700">
