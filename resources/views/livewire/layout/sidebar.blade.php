...
<div x-data="{ collapsed: false }" class="flex flex-col w-74 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
  <!-- Collapse button -->
  <a @click="collapsed = true" x-show="!collapsed" class="flex w-64 items-center justify-center mt-3" href="#">
      <svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
      </svg>
  </a>
  <!-- Expand button -->
  <a @click="collapsed = false" x-show="collapsed" class="flex items-center justify-center mt-3" href="#">
      <svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
  ...
  <!-- This part will collapse when the sidebar is collapsed -->
  <div x-show="!collapsed">
      <div class="w-full px-2">
        ...
        <x-sidebar-link :href="route('users')" :active="request()->routeIs('users')" wire:navigate>
          ...
          <div
          class="flex items-center w-full h-12 px-3 mt-2 ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium transition duration-150 ease-in-out"
          onclick="dropdown()"
        >
          <i class="bi bi-chat-left-text-fill"></i>
          <div class="flex justify-between w-full items-center  text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600">
  ...
  <!-- This part will remain visible when the sidebar is collapsed -->
  <div x-show="collapsed">
