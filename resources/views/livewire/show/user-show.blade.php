        ...
        <form wire:submit.prevent="submit" method="POST">
           <div class="space-y-12">
             ...
             <div class="border-b border-gray-900/10 pb-12">
               <h2 class="text-base font-semibold leading-7 text-gray-900">Show The Selected User</h2>
               ...
               <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                 <div class=" sm:col-span-3">
                   ...
                   <div class="mt-2">
                     <input type="text" wire:model="name" id="name" autocomplete="off" name="name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" disabled>
                   </div>
                 ...
                 <div class="sm:col-span-3">
                   ...
                   <div class="mt-2">
                     <input wire:model="email" id="email" type="email" autocomplete="off" name="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" disabled>
                   </div>
                 ...
                 <div class="relative sm:col-span-4">
                   ...
                   <div class="mt-2">
                     <input type="password" wire:model="password" id="password" name="password" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" disabled>
                   </div>
                    ...
                    <div class="mt-6 space-y-6">
                      @foreach ($roles as $role)
                        <div class="flex items-center gap-x-3">
                          <input id="role-{{ $role->id }}" wire:model="role_id" type="radio" value="{{ $role->id }}" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" disabled>
           ...
           <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            href="{{ route('products.edit', $user->id) }}"
            >Edit</button>
